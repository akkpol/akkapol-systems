...
export const homeContent: Record<Locale, HomeContent> = {
  ...
  th: {
    ...
    hero: {
      ...
      body: ["ผมไม่ได้เริ่มจาก AI — ผมเริ่มจากปัญหาของธุรกิจ", "จากนั้นจึงเลือกใช้เว็บไซต์ ระบบ Workflow หรือ AI ให้เหมาะกับงานนั้นจริง ๆ เป้าหมายคือทำให้ธุรกิจทำงานง่ายขึ้น ทีมทำงานคล่องขึ้น และเจ้าของมีเวลามากขึ้น ผ่านระบบที่ใช้งานได้จริงและเติบโตต่อได้ในอนาคต"],
      primaryCta: "ดู CV",
