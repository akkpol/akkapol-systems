...
const sections = [
  {
    ...
    content: (
      <ul className="space-y-2">
        ...
        <li>
          <strong>Device ID</strong> — ไอดีสุ่มที่ไม่ระบุตัวตนที่สร้างในเบราว์เซอร์
          ของคุณ ใช้สำหรับจำกัดจำนวนข้อความในแชทเท่านั้น ไม่มีข้อมูลส่วนบุคคล
        </li>
        <li>
  ...
  },
  {
    ...
    content: (
      <ul className="space-y-2">
        ...
        <li>
          เราเก็บข้อมูลแชทสูงสุด <strong>12 เดือน</strong> หลังจากข้อความล่าสุด
          จากนั้นจะถูกลบอัตโนมัติ
        </li>
        <li>
