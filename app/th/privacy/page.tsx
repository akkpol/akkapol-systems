...
const sections = [
  {
    ...
    content: (
      <ul className="space-y-2">
        ...
        <li>
          <strong>ข้อมูลลูกค้าเป้าหมาย</strong> — หากคุณให้ช่องทางติดต่อหรือ
          แสดงความสนใจจ้างงานอย่างชัดเจน ข้อมูลแบบมีโครงสร้าง เช่น อีเมล เบอร์โทร
          บริการที่สนใจ และสรุปคำขอแบบสั้น อาจถูกเก็บใน Google Sheet ส่วนตัว
          เพื่อใช้ติดตามกลับ
        </li>
        <li>
  ...
  },
  {
    ...
    content: (
      <ul className="space-y-2">
        ...
        <li>
          เรา <strong>ไม่</strong> ขายหรือใช้ข้อมูลของคุณเพื่อโฆษณา
          และเปิดเผยข้อมูลเฉพาะกับผู้ให้บริการที่ระบุด้านล่างเท่าที่จำเป็น
          ต่อการทำงานของแชทและการติดตามลูกค้าเป้าหมาย
        </li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="space-y-2">
        ...
        <li>
          ข้อมูลลูกค้าเป้าหมายแบบมีโครงสร้างถูกเก็บใน
          <strong> Google Sheet ส่วนตัว</strong> ที่ควบคุมการเข้าถึง
          โดยไม่มีการคัดลอกบทสนทนาฉบับเต็มลงใน Sheet
        </li>
        <li>
  ...
  },
  {
    ...
    content: (
      <ul className="space-y-2">
        ...
        <li>
          <strong>Google</strong> — ใช้พื้นที่ spreadsheet ส่วนตัวเพื่อจัดการ
          ข้อมูลลูกค้าเป้าหมายแบบมีโครงสร้าง ดู{` `}
          <a
